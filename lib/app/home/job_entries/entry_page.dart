...
import 'package:video_project/common_widgets/date_time_picker.dart';
import 'package:video_project/app/home/job_entries/format.dart';
...
class _EntryPageState extends State<EntryPage> {
  ...
  Widget _buildStartDate() {
    return DateTimePicker(
      ...
      onSelectedTime: (time) => setState(() => _startTime = time), key: Key(""),
    );
  }
  ...
  Widget _buildEndDate() {
    return DateTimePicker(
      ...
      onSelectedTime: (time) => setState(() => _endTime = time), key: Key(""),
    );
  }
